...
public:
    ...
    static constexpr const char* araSourceStateKey = "ana.ara.source";
    static constexpr const char* araTakeNumberStateKey = "ana.ara.takeNumber";
    ...
    int getAraAnalysisProgress() const noexcept;
    void requestAraAnalysis(size_t columnCount, bool forceRefresh = false,
                                bool specMapMode = false, size_t specMapRowCount = 2);
    std::shared_ptr<const ana::ara::AnalysisResult> getAraAnalysisResult() const;
    juce::Image getCachedAraSpectrogramImage() const;
    void setCachedAraSpectrogramImage(const juce::Image& image);
    std::vector<ana::ara::SourceChoice> getAraSourceChoices() const;
    juce::String getSelectedAraSourceId() const;
    int getSelectedAraTakeNumber() const noexcept;
    ...
    void setSelectedAraSourceId(const juce::String& sourceId);
    void setSelectedAraTakeNumber(int takeNumber);
...
private:
    ...
    mutable juce::CriticalSection araSelectionLock;
    mutable juce::CriticalSection araSpectrogramImageLock;
    juce::Image cachedAraSpectrogramImage;
    juce::String selectedAraSourceId;
    int selectedAraTakeNumber = 0;
